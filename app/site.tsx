    ...
    <header className="header">
      <div className="nav-wrap">
        <Link href="/" className="brand" aria-label="Farmacia Mascardi, inicio">
          <img src="/images/logo.png" alt="Farmacia Mascardi" />
        </Link>
  ...
  return (
    <footer>
      <div className="footer-grid">
        <div><img src="/images/logo.png" alt="Farmacia Mascardi" className="footer-logo" /><p>Atención profesional y cercana para cuidar tu salud todos los días.</p></div>
...
function Home() {
  return <>
    <section className="home-hero">
      <img src="/images/fachada.jpg" alt="Fachada de Farmacia Mascardi en Urquiza 1073" />
    ...
    <section className="image-band"><img src="/images/interior-principal.jpg" alt="Interior amplio y luminoso de Farmacia Mascardi" /><div><span className="eyebrow light">Estamos para ayudarte</span><h2>Calidad profesional.<br />Trato humano.</h2><Link className="button white" href="/servicios">Ver servicios</Link></div></section>
  </>;
}
...
function Contacto() {
  return <><PageHero eyebrow="Contacto" title="Hablemos." text="Estamos para responder tus consultas y acompañarte con atención profesional." />
    ...
    <section className="contact-image"><img src="/images/interior-3.jpg" alt="Mostrador de atención de Farmacia Mascardi" /></section></>;
}
